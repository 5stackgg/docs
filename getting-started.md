...
5Stack is a comprehensive Counter-Strike management system originally built for
...
Ready to run your own instance? Head to the **[Install guide](/install/)** to get
started, then add [game server nodes](/servers/game-server-nodes/) to host
matches.

---

5Stack aims to be your complete solution for competitive and tournament
Counter-Strike, with both server management and community features built in.
